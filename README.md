...
The pandas, pdfminer.six and exchange_calendars python modules are also required. They automatically installed in a virtual environment if `setup.sh` is run.
